...
public class LocDBHelper extends SQLiteOpenHelper {
	...
	public void generatePoints(String query, String[] selectionArgs) throws MalformedURLException {
			//ArrayList<PointOfInterest>
		//query = "SELECT * FROM NPC_locs";
		//ArrayList<PointOfInterest> results = new ArrayList<PointOfInterest>();
		int t = 0;
		//add column in DB for number of points and call from myApp class
		MyApplication.pointStore = new PointOfInterest[25];
